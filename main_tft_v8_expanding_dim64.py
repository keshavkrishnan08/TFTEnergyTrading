# main_tft_v8_expanding_dim64.py
"""
TFT V8: Expanding Window + 64 Hidden Dim
...
def run_expanding_32():
    print("="*80)
    print("TFT V8: EXPANDING WINDOW + 64 Hidden Dim")
    print("="*80)

    config = Config()
    config.TFT_HIDDEN_DIM = 64
    config.TFT_NUM_HEADS = 4
    config.TFT_NUM_LAYERS = 2
    config.TFT_DROPOUT = 0.5
    config.LEARNING_RATE = 2e-4

    EXPERIMENT_DIR = Path('experiments/tft_v8_expanding_dim64')
    ...
    print("\n" + "="*80)
    print("TFT V8: EXPANDING + 64 DIM - RESULTS")
    print("="*80)
